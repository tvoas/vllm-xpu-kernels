...
#pragma unroll
    ...
    if (hidden_size % 2048 == 0 && (hidden_size / 2048) >= 4) return launch_swiglu(std::integral_constant<int, 32>{});
    if (hidden_size % 1024 == 0 && (hidden_size / 1024) >= 4) return launch_swiglu(std::integral_constant<int, 16>{});
    if (hidden_size %  512 == 0 && (hidden_size /  512) >= 4) return launch_swiglu(std::integral_constant<int, 8>{});
    if (hidden_size %  256 == 0 && (hidden_size /  256) >= 4) return launch_swiglu(std::integral_constant<int, 4>{});
    if (hidden_size %  128 == 0 && (hidden_size /  128) >= 4) return launch_swiglu(std::integral_constant<int, 2>{});
...
#pragma unroll
    ...
    if (hd_size % 2048 == 0 && (hd_size / 2048) >= 4) return launch_scatter(std::integral_constant<int, 32>{});
    if (hd_size % 1024 == 0 && (hd_size / 1024) >= 4) return launch_scatter(std::integral_constant<int, 16>{});
    if (hd_size %  512 == 0 && (hd_size /  512) >= 4) return launch_scatter(std::integral_constant<int, 8>{});
    if (hd_size %  256 == 0 && (hd_size /  256) >= 4) return launch_scatter(std::integral_constant<int, 4>{});
    if (hd_size %  128 == 0 && (hd_size /  128) >= 4) return launch_scatter(std::integral_constant<int, 2>{});
