...
#pragma unroll
    ...
    if (hidden_size % 2048 == 0 && (hidden_size / 2048) >= 10) return launch_swiglu(std::integral_constant<int, 32>{});
    if (hidden_size % 1024 == 0 && (hidden_size / 1024) >= 10) return launch_swiglu(std::integral_constant<int, 16>{});
...
#pragma unroll
    ...
    if (hd_size % 2048 == 0 && (hd_size / 2048) >= 10) return launch_scatter(std::integral_constant<int, 32>{});
    if (hd_size % 1024 == 0 && (hd_size / 1024) >= 10) return launch_scatter(std::integral_constant<int, 16>{});
